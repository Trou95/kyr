...
export const SummaryCard: React.FC<ISummaryCardProps & {className?: string}> = ({ title, description, icon, value, className }) => {

  return (
    <Card className={cn(
      "relative overflow-hidden rounded-2xl shadow-lg transition-transform duration-300 hover:shadow-xl", className
    )}>
